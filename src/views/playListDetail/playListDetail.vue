  ...
  <transition-view>
    <div class="full_header">
      <title-back
        ...
        :transition="true"
        :transition-h="infoH"
        :transitiont-title="listDetail.name"
      ></title-back>
    </div>
    <div class="full_main">
      <div class="container">
          ...
          <div class="datilImg">
            <div class="Mask">
              ...
              >
                ...
                <p class="count">
                  <i class="iconfont icon-mayi-erji-jianbian"></i>{{ listDetail.playCount | playCount_filter }} 万
                </p>
              </div>
            </div>
            <img
              :src="`${listDetail.coverImgUrl}?param=400y400`"
              alt=""
            >
          </div>
          <div class="datilList">
